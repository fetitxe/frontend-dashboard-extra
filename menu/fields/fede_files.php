...
function fed_form_files($options){
	...
	return sprintf(
		'<div class="fed_upload_wrapper %s" %s>
			<button type="button" class="close fed_remove_image" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<div class="fed_upload_container text-center">
				<div class="fed_upload_image_container thumbnail">%s</div>
